...
class RLScanAnimation: NSObject  ,UIViewControllerAnimatedTransitioning{
    ...
    func push(transitionsContext:UIViewControllerContextTransitioning){
        ...
        let startPath = UIBezierPath.init(rect: CGRect.init(x:bounds.size.width, y: 0, width: 0, height: bounds.size.height));
    ...
    func pop(transitionsContext:UIViewControllerContextTransitioning){
        ...
        let endPath = UIBezierPath.init(rect: CGRect.init(x:bounds.size.width, y: 0, width: 0, height: bounds.size.height));
